...
xhr.open("GET", "https://losvisitwad01-be.azurewebsites.net/survey_task?visit_id=" + visit_id + "&survey_id=" + survey_id + "", false);
...
//  console.log("openTask parameter:");
//  console.log(button);
//  let uv = document.getElementById("open_task");
  let d = document.getElementById('task_questions');
  let questionID = d.value;
  if (questionID == "") {
...
/*  let p = button.parentElement;
  let newDiv = document.createElement("DIV");
  newDiv.style = "text-align: left;";
  newDiv.innerHTML = 'New Task created for Question <STRONG>"' + options[options.selectedIndex].text + '"</STRONG>';
  p.insertAdjacentElement("beforeend", newDiv);
*/
